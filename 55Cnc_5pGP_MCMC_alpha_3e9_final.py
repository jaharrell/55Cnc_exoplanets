...
signals = [planet_b, planet_c, planet_f, planet_e, planet_d]
...
# (This only applies to instrumental RV offsets. Kep param bounds fixed below)
...
params = np.loadtxt('/home/3363/55Cnc/text_outputs/55Cnc_5pGP_NM_param_alpha_3000000000_newamp.txt')
...
np.savetxt("/home/3363/55Cnc/text_outputs/MCMC/55Cnc_5pGP_MCMC_chains_alpha_{0:.0f}_newamp.txt".format(alpha), samples.flatten(), header = f"N_MCMC = {nsamples}, alpha = {alpha}, GP_lower_bounds = {GP_lower_bounds}, GP_upper_bounds = {GP_upper_bounds}")

np.savetxt("/home/3363/55Cnc/text_outputs/MCMC/55Cnc_5pGP_MCMC_param_alpha_{0:.0f}_newamp.txt".format(alpha), diagnostics['mu'], header = f"N_MCMC = {nsamples}, alpha = {alpha}, GP_lower_bounds = {GP_lower_bounds}, GP_upper_bounds = {GP_upper_bounds}")

np.savetxt("/home/3363/55Cnc/text_outputs/MCMC/55Cnc_5pGP_MCMC_acceptrate_alpha_{0:.0f}_newamp.txt".format(alpha), diagnostics['alpha'], header = f"N_MCMC = {nsamples}, alpha = {alpha}, GP_lower_bounds = {GP_lower_bounds}, GP_upper_bounds = {GP_upper_bounds}")

np.savetxt("/home/3363/55Cnc/text_outputs/MCMC/55Cnc_5pGP_MCMC_logprob_alpha_{0:.0f}_newamp.txt".format(alpha), diagnostics['logprob'], header = f"N_MCMC = {nsamples}, alpha = {alpha}, GP_lower_bounds = {GP_lower_bounds}, GP_upper_bounds = {GP_upper_bounds}")
